...
void print_help(char *program_name) {
    ...
    printf("Usage: %s <input file path>\n\n"
           ...
           "_<code>_<store-num>_ <p> <cb> <ca> <o> <r> <p> <cb> <ca> <o> <r>\n\n"
           ":                  : :                   : :                   :\n"
           "'---(store data)---' '---(price data)----' '--(discount data)--'\n\n"
           "The value of <code> must be a char type and the remaining values of the line must be unsigned integers.\n"
           "\n\n",
           program_name);
}
...
int main(int argc, char *argv[]) {
    ...
    printf("\nBest relative price: %u\n", best_relative_price(array));
